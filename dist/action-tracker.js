...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["tracker"] = __webpack_require__(3);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tracker = (function () {
	  ...
	  _createClass(Tracker, [{
	    key: '__named',
	    value: function __named(name) {
	      return this.name ? this.name + '.' + name : name;
	    }
	  }, {
	    key: '__create',
	    value: function __create(id) {
	    ...
	    key: '__set',
	    value: function __set(name, value) {
	      ga(this.__named('set'), name, value);
	    }
	  }, {
	    key: '__send',
	    value: function __send(name) {
	      var _this = this;
	      ...
	      return new _Promise(function (resolve) {
	        ...
	        ga(_this.__named('send'), name, options);
	      });
	    }
	  }, {
	    key: 'set',
	    ...
	    key: 'emit',
	    value: function emit(eventCategory, eventAction) {
	      var eventLabel = arguments.length <= 2 || arguments[2] === undefined ? '' : arguments[2];
	      var eventValue = arguments.length <= 3 || arguments[3] === undefined ? null : arguments[3];
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Base, NAME, Constructor, next, DEFAULT, IS_SET, FORCE){
	  __webpack_require__(31)(Constructor, NAME, next);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(name){
	  return store[name] || (store[name] =
	    Symbol && Symbol[name] || (Symbol || __webpack_require__(29))('Symbol.' + name));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(Constructor, NAME, next){
	  Constructor.prototype = $.create(IteratorPrototype, {next: __webpack_require__(23)(1,next)});
...
/***/ function(module, exports, __webpack_require__) {
	...
	species(P);
	species(Wrapper = __webpack_require__(20)[PROMISE]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = function(C){
	  if(__webpack_require__(24) && !(SPECIES in C))$.setDesc(C, SPECIES, {
	    configurable: true,
