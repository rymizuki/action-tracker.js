...
/***/ function(module, exports, __webpack_require__) {
	...
	var _providers = __webpack_require__(70);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _providersGoogleAnalytics = __webpack_require__(24);

	var _providersGoogleAnalytics2 = _interopRequireDefault(_providersGoogleAnalytics);
	...
	var Tracker = (function () {
	  function Tracker() {
	    ...
	    this.provider = null != options.provider ? options.provider : new _providersGoogleAnalytics2['default'](options);
	  ...
	  _createClass(Tracker, [{
	    ...
	    key: 'emit',
	    value: function emit(category, action) {
	    ...
	    key: 'createException',
	    value: function createException(err, options) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Promise = __webpack_require__(25)['default'];
	...
	var GoogleAnalytics = (function () {
	  ...
	  _createClass(GoogleAnalytics, [{
	    ...
	    value: function send(name) {
	      ...
	      return new _Promise(function (resolve) {
	        options.hitCallback = __plantResolver(resolve, options.hitCallback);
	        ga(_this.named('send'), name, options);
	      });
	    }
	  }, {
	    key: 'pageview',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _googleAnalytics = __webpack_require__(24);

	var _googleAnalytics2 = _interopRequireDefault(_googleAnalytics);

	exports['default'] = {
	  GoogleAnalytics: _googleAnalytics2['default']
	};
	module.exports = exports['default'];
